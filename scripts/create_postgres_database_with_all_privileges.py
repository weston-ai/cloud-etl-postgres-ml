# create_postgres_database_with_all_privileges.py

"""
Script Name: create_postgres_database_with_all_privileges.py
...
Logging:
    - Configured via `utils/logging_utils_SCRATCH_1.py`
...
Typical Usage:
    ...
    3. Run the script:
           $ python create_postgres_database_with_all_privileges.py
...
'''
__file__ = "/home/cweston1/miniconda3/envs/PythonProject/projects_prod_testing/cloud_etl_postgres_ml/dev/database_mgmt/create_postgres_database_with_all_privileges.py"
